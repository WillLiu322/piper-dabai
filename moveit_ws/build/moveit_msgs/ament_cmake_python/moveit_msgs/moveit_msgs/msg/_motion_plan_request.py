...
class MotionPlanRequest(metaclass=Metaclass_MotionPlanRequest):
    ...
    def __init__(self, **kwargs):
        ...
        self.smoothness_level = kwargs.get('smoothness_level', float())
    ...
    def __eq__(self, other):
        ...
        if self.max_cartesian_speed != other.max_cartesian_speed:
            return False
        if self.smoothness_level != other.smoothness_level:
            return False
        return True
    ...
    @builtins.property
    def smoothness_level(self):
        """Message field 'smoothness_level'."""
        return self._smoothness_level

    @smoothness_level.setter
    def smoothness_level(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'smoothness_level' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'smoothness_level' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._smoothness_level = value
