...
class Init_MotionPlanRequest_smoothness_level
{
public:
  explicit Init_MotionPlanRequest_smoothness_level(::moveit_msgs::msg::MotionPlanRequest & msg)
  : msg_(msg)
  {}
  ::moveit_msgs::msg::MotionPlanRequest smoothness_level(::moveit_msgs::msg::MotionPlanRequest::_smoothness_level_type arg)
  {
    msg_.smoothness_level = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_MotionPlanRequest_smoothness_level max_cartesian_speed(::moveit_msgs::msg::MotionPlanRequest::_max_cartesian_speed_type arg)
  {
    msg_.max_cartesian_speed = std::move(arg);
    return Init_MotionPlanRequest_smoothness_level(msg_);
  }
