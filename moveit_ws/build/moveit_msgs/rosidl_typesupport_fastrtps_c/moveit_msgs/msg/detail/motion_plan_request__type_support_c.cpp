  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: smoothness_level
  {
    cdr << ros_message->smoothness_level;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name smoothness_level
  {
    size_t item_size = sizeof(ros_message->smoothness_level);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, smoothness_level) +
      last_member_size
      ) == ret_val;
  }
