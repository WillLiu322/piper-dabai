...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotionPlanRequest_message_member_array[16] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs::msg::MotionPlanRequest, smoothness_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
