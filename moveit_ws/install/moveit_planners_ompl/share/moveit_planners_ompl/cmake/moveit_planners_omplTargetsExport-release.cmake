...
set_target_properties(moveit_planners_ompl::moveit_ompl_interface PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ompl_interface.so.2.14.1"
  IMPORTED_SONAME_RELEASE "libmoveit_ompl_interface.so.2.14.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_planners_ompl::moveit_ompl_interface )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_planners_ompl::moveit_ompl_interface "${_IMPORT_PREFIX}/lib/libmoveit_ompl_interface.so.2.14.1" )
...
set_target_properties(moveit_planners_ompl::moveit_ompl_planner_plugin PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmoveit_ompl_planner_plugin.so.2.14.1"
  IMPORTED_SONAME_RELEASE "libmoveit_ompl_planner_plugin.so.2.14.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS moveit_planners_ompl::moveit_ompl_planner_plugin )
list(APPEND _IMPORT_CHECK_FILES_FOR_moveit_planners_ompl::moveit_ompl_planner_plugin "${_IMPORT_PREFIX}/lib/libmoveit_ompl_planner_plugin.so.2.14.1" )
