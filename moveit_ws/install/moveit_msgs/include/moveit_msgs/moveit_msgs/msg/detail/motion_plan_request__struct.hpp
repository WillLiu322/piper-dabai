...
struct MotionPlanRequest_
{
  ...
  using _smoothness_level_type =
    double;
  _smoothness_level_type smoothness_level;
  ...
  Type & set__smoothness_level(
    const double & _arg)
  {
    this->smoothness_level = _arg;
    return *this;
  }
  ...
  bool operator==(const MotionPlanRequest_ & other) const
  {
    ...
    if (this->smoothness_level != other.smoothness_level) {
      return false;
    }
    return true;
  }
