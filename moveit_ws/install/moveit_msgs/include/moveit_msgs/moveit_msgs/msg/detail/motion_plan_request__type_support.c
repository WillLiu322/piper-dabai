...
static rosidl_typesupport_introspection_c__MessageMember moveit_msgs__msg__MotionPlanRequest__rosidl_typesupport_introspection_c__MotionPlanRequest_message_member_array[16] = {
  {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs__msg__MotionPlanRequest, smoothness_level),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
